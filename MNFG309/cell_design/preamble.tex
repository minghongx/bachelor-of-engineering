...
\usepackage{geometry}  % The option showframe is used for debugging overfull \hbox or \vbox
...
\usepackage{setspace}
\setlength{\parskip}{10pt plus 4pt minus 6pt}  % sets spacing between paragraphs
